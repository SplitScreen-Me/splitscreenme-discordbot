...
const Settings = {private: {...devSettings.private}, public: {...devSettings.public}};
...
if(process.env.NODE_ENV === 'production') {
  if(process.env.BOT_PRIVATE){
    ...
    console.log("[Warning] Running in production mode without the BOT_PRIVATE environment set!");
  }
}
